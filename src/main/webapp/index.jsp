								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="row">
										...
										<div class="site_title">
											...
											<p>A perfect solution for all creative folks! You will love Elegant as much as we do. <br/>It will morph perfectly on your needs! There is no limit to what you can accomplish using our template.<br/> Look at it!</p>
										</div>
										<!-- Site Title end-->
										<!-- Countdown start -->
					...
					<div class="row">
						...
						<div class="row">
							...
							<div class="address_part">
								<div class="address">
									<i class="fa fa-map-marker"></i> MatreeNeer <br/> Puthia Stadium Campus <br/> Puthia <br/> Rajshahi, Bangladesh
								</div>
								<div class="phone">
									<i class="fa fa-phone"></i> +88 017 17 515 303
								</div>
								<div class="email">
									<i class="fa fa-envelope-o"></i> mail@yourwebsite.com
								</div>
